...
const jobTitleQueries = {
    jobTitle: {
        ...
        resolve: (source, args, context, info) => get_1.getJobTitle(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobTitle),
    },
    jobTitles: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => get_1.getJobTitles(source, args, context, info),
