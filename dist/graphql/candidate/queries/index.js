...
const candidateQueries = {
    candidate: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getCandidate)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.Candidate),
    },
    candidates: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getCandidates)(source, args, context, info),
