...
const districtQueries = {
    district: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getDistrict)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.District),
    },
    districts: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getDistricts)(source, args, context, info),
