...
const jobLevelQueries = {
    jobLevel: {
        ...
        resolve: (source, args, context, info) => get_1.getJobLevel(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobLevel),
    },
    jobLevels: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => get_1.getJobLevels(source, args, context, info),
