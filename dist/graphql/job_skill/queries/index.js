...
const jobSkillQueries = {
    jobSkill: {
        ...
        resolve: (source, args, context, info) => get_1.getJobSkill(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobSkill),
    },
    jobSkills: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => get_1.getJobSkills(source, args, context, info),
