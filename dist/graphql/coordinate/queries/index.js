...
const coordinateQueries = {
    coordinateText: {
        ...
        resolve: (source, args, context, info) => get_1.getCoordinatesFromText(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_1.CoordinateConnection),
    },
    coordinateLatLong: {
        args: types_1.CoordinateLatLongArgument,
        resolve: (source, args, context, info) => get_1.getCoordinatesFromLatLong(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_1.CoordinateConnection),
    },
};
