...
const jobReplyCommentQueries = {
    jobReplyComment: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getJobReplyComment)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobCommentReply),
    },
    jobReplyComments: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getJobReplyComments)(source, args, context, info),
