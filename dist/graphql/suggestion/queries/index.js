...
const suggestionQueries = {
    suggestion: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getSuggestion)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.Suggestion),
    },
    suggestions: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getSuggestions)(source, args, context, info),
