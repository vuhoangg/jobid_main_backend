...
const jobSaveQueries = {
    jobSave: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getJobSave)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobSave),
    },
    jobSaves: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getJobSaves)(source, args, context, info),
