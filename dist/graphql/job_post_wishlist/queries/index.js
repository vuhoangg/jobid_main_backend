...
const jobPostWishlistQueries = {
    jobPostWishlist: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getJobPostWishlist)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobPostWishlist),
    },
    jobPostWishlists: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getJobPostWishlists)(source, args, context, info),
