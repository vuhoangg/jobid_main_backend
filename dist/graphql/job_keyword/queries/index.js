...
const jobKeywordQueries = {
    jobKeyword: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getJobKeyword)(source, args, context, info),
        type: types_2.JobKeyword,
    },
    jobKeywords: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getJobKeywords)(source, args, context, info),
