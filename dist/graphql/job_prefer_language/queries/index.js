...
const jobPreferLanguageQueries = {
    jobPreferLanguage: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getJobPreferLanguage)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobPreferLanguage),
    },
    jobPreferLanguages: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getJobPreferLanguages)(source, args, context, info),
