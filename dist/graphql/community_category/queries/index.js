...
const communityCategoryQueries = {
    communityCategory: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getCommunityCategory)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.CommunityCategory),
    },
    communityCategorys: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getCommunityCategorys)(source, args, context, info),
