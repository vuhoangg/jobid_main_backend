...
const jobApplyOtherQueries = {
    jobApplyOther: {
        ...
        resolve: (source, args, context, info) => get_1.getJobApplyOther(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobApplyOther),
    },
    jobApplyOthers: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => get_1.getJobApplyOthers(source, args, context, info),
