...
const jobPostQueries = {
    jobPost: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getJobPost)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobPost),
    },
    jobPosts: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getJobPosts)(source, args, context, info),
