...
const jobRegisterQueries = {
    jobRegister: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getJobRegister)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobRegister),
    },
    jobRegisters: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getJobRegisters)(source, args, context, info),
