...
const profileViewQueries = {
    profileView: {
        ...
        resolve: (source, args, context, info) => get_1.getProfileView(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.ProfileView),
    },
    profileViews: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => get_1.getProfileViews(source, args, context, info),
