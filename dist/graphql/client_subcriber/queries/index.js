...
const clientSubcriberQueries = {
    clientSubcriber: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getClientSubcriber)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.ClientSubcriber),
    },
    clientSubcribers: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getClientSubcribers)(source, args, context, info),
