...
const companyNotificationRegisterQueries = {
    companyNotificationRegister: {
        ...
        resolve: (source, args, context, info) => get_1.getCompanyNotificationRegister(source, args, context, info),
        type: types_2.CompanyNotificationRegister,
    },
    companyNotificationRegisters: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => get_1.getCompanyNotificationRegisters(source, args, context, info),
