...
const curriculumVitaeQueries = {
    curriculumVitae: {
        ...
        resolve: (source, args, context, info) => get_1.getCurriculumVitae(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(index_1.CurriculumVitae),
    },
    curriculumVitaes: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => get_1.getCurriculumVitaes(source, args, context, info),
