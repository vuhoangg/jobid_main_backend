...
const cvEmployerQueries = {
    cvEmployer: {
        ...
        resolve: (source, args, context, info) => get_1.getCvEmployer(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.CvEmployer),
    },
    cvEmployers: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => get_1.getCvEmployers(source, args, context, info),
