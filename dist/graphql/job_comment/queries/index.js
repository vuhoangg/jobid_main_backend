...
const jobCommentQueries = {
    jobComment: {
        ...
        resolve: (source, args, context, info) => (0, get_1.getJobComment)(source, args, context, info),
        type: new graphql_1.GraphQLNonNull(types_2.JobComment),
    },
    jobComments: {
        args: types_1.PaginationArguments,
        resolve: (source, args, context, info) => (0, get_1.getJobComments)(source, args, context, info),
