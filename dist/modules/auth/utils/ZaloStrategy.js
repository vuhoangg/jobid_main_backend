...
ZaloStrategy.prototype.authenticate = function (req, options) {
    ...
    try {
        ...
        if (!req.query || (req.query && !req.query.code)) {
            return self.redirect(`https://oauth.zaloapp.com/v3/permission?app_id=${process.env.ZALO_APP_ID}&redirect_uri=${encodeURIComponent(`${process.env.API_URL}/auth/zalo/callback`)}`);
        }
        else {
...
//# sourceMappingURL=ZaloStrategy.js.map